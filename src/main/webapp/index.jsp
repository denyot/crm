...
<div data-options="region:'north'" style="height:100px;background: url('images/banner-pic.gif') no-repeat;background-size: cover;">
    <h1>心烽的系统</h1>
</div>
<div data-options="region:'south'" style="height:20px;background: url('images/banner-pic.gif') no-repeat;background-size: cover;">
